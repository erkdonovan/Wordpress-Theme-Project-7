...
function hackeryou_widgets_init() {
  ...
  //   'before_widget' => '<li class="contact-section">',
  //   'after_widget' => '</li>',
  //   'before_title' => '<h4>',
  //   'after_title' => '</h4>',
  // ) );
...
// add_filter('footer-widget-area', 'edonvan_footer-widget-area');

// function edonovan_footer-widget-area( $params ) {
//   // get widget vars
...
//   $fawesome = get_field('text', 'widget_' . $widget_id);
//   if( $fawesome ) {
//     $params[0]['before_widget'] = '<i class="fa $fawesome" aria-hidden="true">      </i>' . $params[0]['before_widget'];
//   }
//   // return
//   return $params;
